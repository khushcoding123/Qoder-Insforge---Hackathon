...
function LoginPageInner() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <AuthShell
        title={step === "form" ? "Welcome back" : "Verify your email"}
        description={
          step === "form"
            ? "Sign in to continue your trading education with the same focused workspace and progress across every tool."
