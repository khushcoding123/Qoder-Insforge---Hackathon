...
import { TrendingUp, Eye, EyeOff, Loader2, Mail, Lock, User, AlertCircle } from "lucide-react";
        ...
        <div className="bg-[#0F0F1A] border border-white/10 rounded-2xl p-8 shadow-xl">
          {step === "form" ? (
            <>
              ...
              <p className="text-gray-400 text-sm mb-6">Start your personalized trading education journey.</p>
            ...
            <>
              ...
              <form onSubmit={handleVerify} className="space-y-4">
                <div>
                  <label className="block text-sm text-gray-400 mb-1.5 text-center">Verification Code</label>
                  <input
                    type="text"
                    value={otp}
